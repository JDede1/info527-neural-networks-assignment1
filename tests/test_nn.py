...
Original file is located at
    https://colab.research.google.com/drive/1m97ukAcwJhSi2LNrFdBQXS6OR1Vef0d7
"""
...
Original file is located at
    https://colab.research.google.com/drive/1cLg2zUmVZIcHV5ryylfrv0VFVASoZ3gJ
"""
...
def test_indexes():
    ...
    index = stv_nn.Index(vocab, start=1)
...
def test_duplicates_in_vocabulary():
    ...
    index = stv_nn.Index(vocab, start=2)
...
def test_out_of_vocabulary():
    ...
    index = stv_nn.Index(vocab, start=3)
...
def test_binary_vector():
    ...
    index = stv_nn.Index(vocab, start=4)
